    ...
    lucide.createIcons();
        ...
        const translations = {
            ru: {
                ...
                hero_title: "РЕМОНТ КВАРТИР И ДОМОВ ПОД КЛЮЧ В ВАЛЕНСИИ", hero_desc: "Создаем идеальные интерьеры для жизни и бизнеса. Берем на себя всё: от разработки дизайн-проекта и получения лицензий (Licencia de obra) до финальной уборки.", btn_estimate: "Рассчитать смету", btn_our_projects: "Наши объекты",
                services_title: "УСЛУГИ ПО РЕМОНТУ В ВАЛЕНСИИ", services_desc: "Выполняем полный цикл строительно-отделочных работ с соблюдением испанских норм и европейских стандартов качества.",
                serv_1_title: "Комплексный ремонт квартир", serv_1_desc: "Капитальный ремонт квартир и вилл под ключ. Демонтаж, коммуникации, черновая и чистовая отделка.",
                serv_2_title: "Дизайн интерьера в Валенсии", btn_details: "Подробнее",
                serv_3_title: "Ремонт коммерческих помещений", serv_3_desc: "Адаптация помещений под рестораны, офисы и магазины. Согласование проекта с Ayuntamiento.",
                ...
                portf_title: "ПОРТФОЛИО: РЕМОНТ КВАРТИР В ВАЛЕНСИИ", portf_1_tag: "Апартаменты • Ruzafa", portf_1_title: "Капитальный ремонт квартиры в районе Ruzafa", portf_1_desc: "Полная перепланировка в историческом фонде, сохранение оригинальной кирпичной кладки, замена перекрытий.", portf_2_tag: "Дом • El Cabañal", portf_2_title: "Реконструкция таунхауса в El Cabanyal", portf_2_desc: "Восстановление фасада, создание открытой террасы на крыше, монтаж системы Умный дом и теплых полов.", portf_3_tag: "Ресторан • Av. de França, 14", portf_3_title: "Ремонт ресторана Pasqual&Sheila под ключ", portf_3_desc: "Полная адаптация помещения под требования ресторана, обустройство профессиональной кухни, систем вентиляции и клиентского зала.", portf_4_tag: "Апартаменты • Ciutat Vella", portf_4_title: "Реновация апартаментов в Ciutat Vella", portf_4_desc: "Реализация эксклюзивного дизайн-проекта с использованием премиальных материалов, скрытых дверей и световых линий.", portf_5_tag: "Салон красоты • Plaça de Vannes, 6", portf_5_title: "Ремонт салона красоты Misha: полный цикл", portf_5_desc: "Обустройство рабочих зон, специальное освещение с правильным индексом цветопередачи, монтаж мокрых точек и стильный ресепшн.", portf_6_tag: "Квартира • Eixample", portf_6_title: "Комплексный ремонт квартиры в L'Eixample", portf_6_desc: "Светлая и просторная квартира для молодой семьи. Черновая и чистовая отделка, замена всех коммуникаций и монтаж аэротермии.",
            ...
            es: { 
                ...
                hero_title: "REFORMA DE PISOS Y CASAS LLAVE EN MANO EN VALENCIA", hero_desc: "Creamos interiores perfectos para vida y negocio. Nos encargamos de todo: diseño, licencias de obra y limpieza final.", btn_estimate: "Pedir presupuesto", btn_our_projects: "Nuestros proyectos",
                services_title: "SERVICIOS DE REFORMA EN VALENCIA", services_desc: "Realizamos el ciclo completo de obras y acabados cumpliendo normativas españolas y estándares europeos.",
                serv_1_title: "Reforma integral de piso en L'Eixamples", serv_1_desc: "Reformas de pisos y chalets llave en mano. Demoliciones, instalaciones y acabados.",
                serv_2_title: "Diseño de interiores en Valencia", btn_details: "Saber más",
                serv_3_title: "Reforma de locales comerciales", serv_3_desc: "Adaptación de locales para restaurantes, oficinas. Gestión con el Ayuntamiento.",
                ...
                portf_title: "PORTAFOLIO: REFORMA DE PISOS EN VALENCIA", portf_1_tag: "Piso • Ruzafa", portf_1_title: "Reforma integral de piso en Ruzafa", portf_1_desc: "Redistribución completa en edificio histórico, conservando el ladrillo caravista original.", portf_2_tag: "Casa • El Cabañal", portf_2_title: "Rehabilitación de adosado en El Cabanyal", portf_2_desc: "Restauración de fachada, creación de terraza abierta, instalación de domótica y suelo radiante.", portf_3_tag: "Restaurante • Av. de França, 14", portf_3_title: "Reforma llave en mano del restaurante Pasqual&Sheila", portf_3_desc: "Adaptación completa para restaurante, cocina profesional, sistemas de ventilación y zona de clientes.", portf_4_tag: "Apartamentos • Ciutat Vella", portf_4_title: "Renovación de apartamentos en Ciutat Vella", portf_4_desc: "Proyecto de diseño exclusivo con materiales premium, puertas invisibles y líneas de luz.", portf_5_tag: "Salón de belleza • Plaça de Vannes, 6", portf_5_title: "Reforma del salón de belleza Misha: ciclo completo", portf_5_desc: "Zonas de trabajo, iluminación especial con alto índice de reproducción cromática y recepción.", portf_6_tag: "Piso • Eixample", portf_6_title: "Reforma integral de piso en L'Eixample", portf_6_desc: "Piso luminoso para una familia joven. Acabados completos, cambio de instalaciones y aerotermia.",
            ...
            uk: {
                ...
                hero_title: "РЕМОНТ КВАРТИР І БУДИНКІВ ПІД КЛЮЧ У ВАЛЕНСІЇ", hero_desc: "Створюємо ідеальні інтер'єри для життя та бізнесу. Беремо на себе все: від дизайн-проекту та ліцензій до фінального прибирання.", btn_estimate: "Розрахувати кошторис", btn_our_projects: "Наші об'єкти",
                services_title: "ПОСЛУГИ З РЕМОНТУ У ВАЛЕНСІЇ", services_desc: "Виконуємо повний цикл будівельно-оздоблювальних робіт з дотриманням іспанських норм та європейських стандартів якості.",
                serv_1_title: "Комплексний ремонт квартири в L'Eixample квартир", serv_1_desc: "Капітальний ремонт квартир та вілл під ключ. Демонтаж, комунікації, чорнова та чистова обробка.",
                serv_2_title: "Дизайн інтер'єру у Валенсії", btn_details: "Детальніше",
                serv_3_title: "Ремонт комерційних приміщень", serv_3_desc: "Адаптація приміщень під ресторани, офіси. Узгодження проекту з Ayuntamiento.",
                ...
                portf_title: "ПОРТФОЛІО: РЕМОНТ КВАРТИР У ВАЛЕНСІЇ", portf_1_tag: "Апартаменти • Ruzafa", portf_1_title: "Капітальний ремонт квартири в районі Ruzafa", portf_1_desc: "Повне перепланування в історичному фонді, збереження цегляної кладки.", portf_2_tag: "Будинок • El Cabañal", portf_2_title: "Реконструкція таунхауса в El Cabanyal", portf_2_desc: "Відновлення фасаду, створення відкритої тераси на даху.", portf_3_tag: "Ресторан • Av. de França, 14", portf_3_title: "Ремонт ресторану Pasqual&Sheila під ключ", portf_3_desc: "Адаптація приміщення під вимоги ресторану, системи вентиляції.", portf_4_tag: "Апартаменти • Ciutat Vella", portf_4_title: "Реновація апартаментів у Ciutat Vella", portf_4_desc: "Ексклюзивний дизайн-проект з використанням преміальних матеріалів.", portf_5_tag: "Салон краси • Plaça de Vannes, 6", portf_5_title: "Ремонт салону краси Misha: повний цикл", portf_5_desc: "Облаштування робочих зон, спеціальне освітлення, стильний ресепшн.", portf_6_tag: "Квартира • Eixample", portf_6_title: "Комплексний ремонт квартири в L'Eixample", portf_6_desc: "Світла квартира для сім'ї. Чорнова і чистова обробка.",
